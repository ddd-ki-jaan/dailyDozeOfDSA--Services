...
import styles from "./NishantChahar151DSASheet.module.css";
...
function NishantChahar151DSASheet({ sheetEnum }) {
  const pageTitle =
    "Nishant Chahar's 151 DSA Sheet - Solve DSA Problems for Interview Success";
  const pageDescription =
    "Tackle Nishant Chahar's 151 DSA Sheet, a curated collection of essential DSA problems to boost your interview preparation. Track your progress and master each topic.";
  ...
  useEffect(() => {
    const fetchNishantChaharSDESheetData = async () => {
      try {
        const response = await getNishantChaharSDESheet();
    ...
    fetchNishantChaharSDESheetData();
  }, []);
  ...
  return (
    <>
      ...
      <div className="page-container">
        ...
        {nishantChaharSDESheetData.map((currTopicData) => (
          <ProblemTopic
...
export default NishantChahar151DSASheet;
